---
title: "`r if (nzchar(params$scenario)) paste0('Norma Evaluation Diffing - ', params$scenario) else 'Norma Evaluation Diffing'`"
...
The following chart compares the throughput of the runs over time.
