...
require (
	github.com/0xsoniclabs/carmen/go v0.0.0-20260413073511-38e882c830d4 // indirect
...
replace github.com/ethereum/go-ethereum => github.com/0xsoniclabs/go-ethereum v0.0.0-20260316131102-1779772a79a7
