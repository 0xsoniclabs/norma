...
// Source: github.com/0xsoniclabs/norma/driver/rpc (interfaces: Client,ethRpcClient,rpcClient)
//
// Generated by this command:
//
//	mockgen -destination rpc_mock.go -package rpc . Client,ethRpcClient,rpcClient
//
