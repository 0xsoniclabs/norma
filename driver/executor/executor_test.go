...
func TestExecutor_scheduleCheckEvents(t *testing.T) {
	...
	checking.RegisterSupportedCheck("tester", func(net driver.Network, monitor *monitoring.Monitor) checking.Checker {
		return checker
	})

	checker2 := checking.NewMockChecker(ctrl)
	checking.RegisterSupportedCheck("tester2", func(net driver.Network, monitor *monitoring.Monitor) checking.Checker {
		return checker2
	})

	checker3 := checking.NewMockChecker(ctrl)
	checking.RegisterSupportedCheck("tester3", func(net driver.Network, monitor *monitoring.Monitor) checking.Checker {
		return checker3
	})
