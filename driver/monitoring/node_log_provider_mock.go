...
//
//	mockgen -source node_log_provider.go -destination node_log_provider_mock.go -package monitoring
//
...
func (mr *MockLogListenerMockRecorder) OnBlock(node, block any) *gomock.Call {
...
func (mr *MockNodeLogProviderMockRecorder) RegisterLogListener(listener any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockNodeLogProviderMockRecorder) UnregisterLogListener(listener any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
