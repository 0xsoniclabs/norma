...
//
//	mockgen -source prom_log_provider.go -destination prom_log_provider_mock.go -package monitoring
//
...
func (mr *MockTimeLogListenerMockRecorder) OnLog(node, timestamp, value any) *gomock.Call {
...
func (mr *MockPrometheusLogProviderMockRecorder) RegisterLogListener(key, listener any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPrometheusLogProviderMockRecorder) UnregisterLogListener(key, listener any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
