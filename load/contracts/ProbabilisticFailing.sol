...
contract ProbabilisticFailing {
    ...
    function incrementCounter(uint8 failureProbability, uint32 seed) public {
        ...
        uint256 rand = uint256(keccak256(abi.encodePacked(msg.sender, count, block.timestamp, seed)));
