...
//
//	mockgen -source shaper.go -destination shaper_mock.go -package shaper
//
...
func (mr *MockShaperMockRecorder) GetNumMessagesInInterval(start, duration any) *gomock.Call {
...
func (mr *MockShaperMockRecorder) Start(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
